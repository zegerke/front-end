/*==================================================================================================
        ...
        function DoThingsWithTheDom() {
          ...
          document.getElementById('id').innerHTML="#"+pokemon_id ;
          document.getElementById('oves').innerHTML="Moves : ";
          document.getElementById('moves').innerHTML=pokemon_moves ;
            document.getElementById('bilities').innerHTML="Abilities : ";
          document.getElementById('abilities').innerHTML=pokemon_abilities ;
          document.getElementById('image').src=pokemon_image;
            document.getElementById('eight').innerHTML="Weight : ";
